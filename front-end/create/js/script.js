...
async function createContact() {
    ...
    const homephone = document.getElementById(
      "contact-homephonenumber"
    );
    const workphone = document.getElementById(
    ...
    headers.append("Authorization", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiNjA4MTM0OGItOGQwMS00MWRhLTllZmYtZTdhYmEwZTNhMTE1IiwiaWF0IjoxNjY5Mzk2NTQ2LCJleHAiOjE2Njk0MDAxNDZ9.V93f4vy0s-M1dTf2h_2eTcDw_DZow-zpazE4RCPmcTk");
